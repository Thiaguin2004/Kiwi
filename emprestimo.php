...
function ferramenta(t)
{
   ...
   codigo = t.value;
   chamada = "index2.php?prog=emprestimo.php&itemferr=" + codigo + "&campofoco=matricula";
...
function funcionario(t)
{
   ...
   chamada = "index2.php?prog=emprestimo.php&codfunc=" + codigo +"&itemferr=" + codferr +"&campofoco=B1" ;
...
<p align="center"><b><font face="Arial">EMPRÉSTIMO DE FERRAMENTAS</font></b></p>
<form method="GET" action="incluir_emprestimo.php" name="form0" id="form0">
	...
	<div align="center">
		<table border="0" width="50%" cellspacing="0" cellpadding="4" bgcolor="#C0C0C0">
			...
			<tr>
				<td width="293"><b><font face="Arial">DATA DEVOLUÇÃO</font></b></td>
				<td>
				<input type="text" name="dataprevistadevolucao" value="<?php $date = new DateTime('now'); echo $date->format('d/m/Y');?>" size="15" style="font-family: Arial; font-size: 18pt"></td>
			</tr>
			<tr>
				<td width="293">&nbsp;</td>
				<td><input type="submit" value="INSERIR" id="B1" name="B1" <?php if( ($nomefer=="") || ($nomefun=="")) echo "DISABLED" ?> > <input type="reset" value="CANCELAR" name="B2"></td>
			</tr>
		</table>
	</div>
	<p>&nbsp;</p>
